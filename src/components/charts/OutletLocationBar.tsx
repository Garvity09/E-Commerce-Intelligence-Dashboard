...
interface OutletLocationBarProps {
  data: { name: string; sales: number; count: number }[];
}

export default function OutletLocationBar({ data }: OutletLocationBarProps) {
  ...
  const COLORS = [CHART_COLORS.olive, CHART_COLORS.lime, CHART_COLORS.forest];
